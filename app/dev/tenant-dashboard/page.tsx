              ...
              <Card key={application.id} className="rounded-3xl">
                <CardContent className="p-6">
                  ...
                  <div className="mt-4">
                    ...
                    {application.status === "Approved" && (
                      <Button className="bg-[#00ae89] hover:bg-[#009b7a] rounded-3xl px-6">
                        Sign Lease
                      </Button>
                    )}
                  </div>
        ...
        <TabsContent value="messages">
          <div className="space-y-4">
            {messages.map((message) => (
              <Card
                key={message.id}
                className={`${message.unread ? "border-l-4 border-l-[#00ae89]" : ""} rounded-3xl`}
              >
                <CardContent className="p-6">
                  <div className="flex justify-between items-center">
            ...
            <CardContent>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Badge className="bg-green-500 rounded-full px-4 py-1.5">
                    Verified
                  </Badge>
                </div>
                ...
                <Button className="bg-[#00ae89] hover:bg-[#009b7a] rounded-3xl px-6 py-3">
                  Edit Profile
                </Button>
              </div>
            </CardContent>
