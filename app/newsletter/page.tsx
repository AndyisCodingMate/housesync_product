          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="p-8">
              ...
              <p className="text-lg text-center mb-12 max-w-3xl mx-auto">
                ...
                SpartUp x CED Hackathon, a competitive event showcasing
                innovative ideas. The project stood out for its unique approach
                to solving housing challenges for international students through
                features like dual verification and secure transactions. This
                win highlights HouseSync's potential to make a significant
                impact in the rental market and validates the hard work and
              ...
              <div className="border-t border-gray-200 pt-8 mb-8">
                <h3 className="text-2xl font-bold text-[#1d4ed8] text-center mb-2">
              ...
              <div className="bg-gray-50 p-8 text-center">
                <p className="text-lg">
                  HouseSync is a secure rental platform for international
                  students in the U.S., offering dual verification to
                  authenticate landlords and tenants, and move-in verification
                  to prevent scams. It also regulates transactions to ensure
                  fairness in disputes or cancellations, providing a reliable
                  solution for housing challenges.
                </p>
              </div>
            </div>
          </div>
