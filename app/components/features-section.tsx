...
const features = [
  ...
  {
    name: "Verified Users",
    description: "We verify both tenants and landlords to create a safe and trustworthy rental environment.",
    icon: UserCheck,
  },
  {
    name: "Secure Process",
    description: "Our platform ensures secure communication and transaction processes for all parties involved.",
    icon: Shield,
  },
  {
    ...
    <div className="py-12 bg-white" id="features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h2 className="text-base text-[#00ae89] font-semibold tracking-wide uppercase">Features</h2>
          <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            Revolutionizing the rental experience
          </p>
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            HouseSync offers a comprehensive set of tools to make renting safer, faster, and more efficient for both
