        ...
        <FadeInAnimation>
          ...
          <SlowFadeInAnimation>
            <p className="text-xl text-center text-gray-600 mb-12">
              At HouseSync, we value your privacy and are committed to protecting your personal information.
            </p>
          </SlowFadeInAnimation>

          <PolicySection title="Introduction">
            <p className="mb-4 text-gray-700 leading-relaxed">
              Welcome to HouseSync's Privacy Policy. This policy describes how we collect, use, and handle your personal
              information when you use our services. We are committed to ensuring that your privacy is protected and
          ...
          <PolicySection title="Data Security">
            <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              is 100% secure. We strive to use commercially acceptable means to protect your personal information, but
          ...
          <PolicySection title="Your Rights">
            ...
            <ul className="list-disc list-inside mb-4 text-gray-700 space-y-2">
              ...
              <li>Request a copy of your information in a structured, commonly used, and machine-readable format</li>
            </ul>
          </PolicySection>
          ...
          <PolicySection title="Changes to This Policy">
            <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              privacy policy on this page and updating the "Last updated" date at the bottom of this policy. We
          ...
          <PolicySection title="Contact Us">
            ...
            <Link href="mailto:andypoon@housesync.us" className="text-[#00ae89] hover:underline flex items-center">
